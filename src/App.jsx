  ...
  return (
    ...
    <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
        ...
        <div className='flex  flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-xl'> 
          ...
          <button onClick={() => setColor("blue")} className=' outline-none px-4 py-1 rounded-full text-black shadow-lg' style={{ background:"blue"}}>Blue</button>
          ...
          <button onClick={() => setColor("orange")} className=' outline-none px-4 py-1 rounded-full text-black shadow-lg' style={{ background:"orange"}}>Orange</button>
          <button onClick={() => setColor("navy")} className=' outline-none px-4 py-1 rounded-full text-white shadow-lg' style={{ background:"navy"}}>Navyblue</button>
        </div>
    </div>
    </div>
  )
